...
'license'=>'<div class="license"><h1>系统安装协议</h1>
				...
				<p>感谢您选择吾爱源码微信营销平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改好站长微信营销平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用好站长微信营销平台，还是部份栏目使用 微信营销平台，在你使用了好站长微信营销平台的网站主页上必须加上好站长微信营销平台  官方网址(<a href="http://www.haoid.cn" target="_blank">www.haoid.cn"</a>)的链接。</p>
				<p>4、未经官方许可，禁止在好站长微信营销平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：V18</b></p>
                <p align=right>BY 吾爱源码微信营销平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 吾爱源码微信营销平台安装程序BBS.52CODES.NET',
...
<meta content="好站长微信营销平台" name="Copyright" />
